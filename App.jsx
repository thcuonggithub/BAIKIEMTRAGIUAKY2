...
const data = [
  {
    ...
    imageSmall: "/spy_carousel_1.png",
    imageLarge: "./spy_carousel_2.png",
    episode: "01"
  },
  {
    id: "2",
    ...
    imageSmall: "./One-piece_1.png",
    imageLarge: "./One-piece_2.png",
    episode: "1018"
  },
  {
    id: "3",
    ...
    imageSmall: "./boruto-naruto-next-generations_1.png",
    imageLarge: "./boruto-naruto-next-generations_2.png",
    episode: "250"
  },
  {
    id: "4",
    ...
    imageSmall: "./spy_card_1.png",
    imageLarge: "./spy_card_2.png",
    episode: "07"
  },
  {
    id: "5",
    ...
    imageSmall: "./attackontitan_1.png",
    imageLarge: "./attackontitan_2.png",
    episode: "28"
  },
  {
    id: "6",
    ...
    imageSmall: "./captsu_card_1.png",
    imageLarge: "./captsu_card_2.png",
    episode: "28"
  },
  {
    id: "7",
    ...
    imageSmall: "./aoashi_card_1.png",
    imageLarge: "./aoashi_card_2.png",
    episode: "28"
  }
];
...
const App = () => {
  ...
  return (
    <div className="Home">
      ...
      <NewRelease movies={data} onMovieClick={handleMovieClick} />
    </div>
  );
}

const Explore = ({ selectedMovie }) => (
  <section className="explore" style={{ backgroundImage: `url(${selectedMovie.imageLarge})` }}>
    <div className="Text">
      <h2>Explore</h2>
      <p className='watch'>What are you gonna watch today ?</p>
    </div>
    ...
    <div className="movies-list">
      {movies.map((movie) => (
        <div key={movie.id} className="movie-item" onClick={() => onMovieClick(movie)}>
          <img src={movie.imageSmall} alt={movie.movieName} className="small-image" />
          <p className='typeMovie'>Episode {movie.episode}</p>
          <p className='nameMovie'>{movie.movieName}</p>
        </div>
      ))}
    </div>
  </section>
